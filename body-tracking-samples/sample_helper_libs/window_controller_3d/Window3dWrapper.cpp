...
void Window3dWrapper::SetJointRadius(float radius)
{
	m_window3d.SetJointRadius(radius);
}

void Window3dWrapper::SetBoneRadius(float radius)
{
	m_window3d.SetBoneRadius(radius);
}
...
void Window3dWrapper::SetCoordFrameAxisThickness(float thickness)
{
	m_window3d.SetFrameAxisThickness(thickness);
}

void Window3dWrapper::SetCoordFrameAxisLength(float length)
{
	m_window3d.SetFrameAxisLength(length);
}
