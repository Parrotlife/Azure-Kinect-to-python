...
void WindowController3d::SetJointRadius(float radius)
{
	m_skeletonRenderer.SetJointRadius(radius);
}

void WindowController3d::SetBoneRadius(float radius)
{
	m_skeletonRenderer.SetBoneRadius(radius);
}

void WindowController3d::SetFrameAxisThickness(float thickness)
{
	m_skeletonRenderer.SetFrameAxisThickness(thickness);
}

void WindowController3d::SetFrameAxisLength(float length)
{
	m_skeletonRenderer.SetFrameAxisLength(length);
}
